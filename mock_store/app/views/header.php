<header class = "header">
	<ul class = "header_box">
        ...
        <li class="list_search"><a href = ""><img src="img/icon_search.png" class = "icon_search" /></a></li>
        <li class="list_user"><a href = ""><img src="img/icon_search.png" class = "icon_user" /></a></li>
    </ul>
</header>
