...
<div class = "login_box">
	...
	<input type="text" name="mail_address" maxlength="50" placeholder="メールアドレス" class = "form_box" />
    <input type="text" name="password" maxlength="30" placeholder="パスワード" class = "form_box" />
