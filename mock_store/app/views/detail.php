...
<div class = "wrapper">
    <section class = "app_imgs">
    	<div class = "scroller">
        	<?php if(!empty($db->image1_path)){ ?><div class = "app_img_container"><img src="<?php echo $db->image1_path; ?>" class = "app_img" data-lightbox = "1" /></div><?php } ?>
        	<?php if(!empty($db->image2_path)){ ?><div class = "app_img_container"><img src="<?php echo $db->image2_path; ?>" class = "app_img" data-lightbox = "2" /></div><?php } ?>
        	<?php if(!empty($db->image3_path)){ ?><div class = "app_img_container"><img src="<?php echo $db->image3_path; ?>" class = "app_img" data-lightbox = "3" /></div><?php } ?>
        </div>
    </section>
    <hr class = "separation" />
